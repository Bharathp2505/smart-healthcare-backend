...
public class ContactController {
    ...
    public ResponseEntity<String> getInTouch(@Valid @RequestBody GetInTouchRequest getInTouchRequest) {
        try {
        ...
        return ResponseEntity.ok("Thanks for reaching out! We'll get back to you soon.");
    }
}
